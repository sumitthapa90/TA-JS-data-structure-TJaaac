...
for (let people of gameOfThrones.houses[0].people) {
  console.log(`I am ${people.name}and my bio is ${people.description}`);
}
...
console.log(gameOfThrones.houses[0].people.length);

// 13. Log the size of people in Lannisters house

console.log(gameOfThrones.houses[1].people.length);
...
let allDescription = [];
for(let house of gameOfThrones.houses){
  for(let discription of house.people){
    allDescription.push(discription.discription)
  }
}
